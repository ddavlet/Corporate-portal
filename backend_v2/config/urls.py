...
from apps.tenants.views import (
    ...
    TenantPayrollDocIdFormatView,
    TenantPayrollSettingsView,
...
urlpatterns = [
    ...
    path(
        "api/tenant/payroll-doc-id-format/",
        TenantPayrollDocIdFormatView.as_view(),
        name="tenant_payroll_doc_id_format",
    ),
    path(
        "api/tenant/payroll-settings/",
        TenantPayrollSettingsView.as_view(),
        name="tenant_payroll_settings",
    ),
