        ...
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                drop_fk_index_operation(
                    ...
                    ("requests", "RequestAttachment", "request"),
                    ("requests", "RequestAttachment", "tenant"),
                    ("requests", "Approval", "request"),
                    ("requests", "RequestCategory", "tenant"),
                    ("requests", "RequestFormPaymentTypeConfig", "config"),
                    ("requests", "RequestFormPaymentTypeRequester", "payment_type_config"),
                    ("requests", "RequestFormPaymentTypeVendor", "payment_type_config"),
                    ("requests", "RequestPaymentPurposeConfig", "payment_type_config"),
                    ("requests", "RequestApprovalPaymentTypeConfig", "config"),
                    ("requests", "RequestApprovalStepConfig", "payment_type_config"),
                    ("requests", "RequestApprovalStepApproverConfig", "step_config"),
                    ("requests", "RequestApprovalPurposeExceptionConfig", "payment_type_config"),
                    ("requests", "RequestApprovalPurposeExceptionPurpose", "exception_config"),
                    ("requests", "RequestApprovalPurposeExceptionPurpose", "payment_type_config"),
                    ("requests", "RequestApprovalPurposeExceptionStepConfig", "exception_config"),
                    ("requests", "RequestApprovalPurposeExceptionStepApproverConfig", "step_config"),
                    ("requests", "AutoRequestTemplate", "tenant"),
                    ("requests", "RequestComment", "request"),
                ),
            ],
        ),
    ]
