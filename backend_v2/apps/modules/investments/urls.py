...
from apps.modules.investments.views import (
    ...
    InvestPayoutScheduleLinkReturnsView,
...
urlpatterns = [
    ...
    path(
        ...
        InvestPayoutScheduleMarkPaidView.as_view(),
        name="invest-payout-mark-paid",
    ),
    path(
        "payout-schedule/<int:schedule_id>/link-returns/",
        InvestPayoutScheduleLinkReturnsView.as_view(),
        name="invest-payout-link-returns",
    ),
