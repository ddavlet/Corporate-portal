            ...
            database_operations=[
                migrations.RunSQL(
                    sql="""
                        ...
                        CREATE INDEX IF NOT EXISTS notif_tenant_kind_created_idx
                            ON notifications (tenant_id, kind, created_at);
                        CREATE INDEX IF NOT EXISTS notif_source_idx
                            ON notifications (content_type_id, object_id);
                    """,
