...
class TaskAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ("created_at", "updated_at", "completed_at", "last_admin_comment_at", "last_seen_at")
    raw_id_fields = ("tenant", "assignee", "created_by", "source_approval", "source_request")
