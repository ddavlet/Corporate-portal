...
docker compose --env-file ./.env build backend_v2 frontend_v2 tg-gateway
...
docker compose --env-file ./.env up -d --no-deps backend_v2 frontend_v2 tg-gateway
                          # перезапускаем backend_v2, frontend_v2 и tg-gateway
